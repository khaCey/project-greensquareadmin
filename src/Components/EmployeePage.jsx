...
import { Button, ButtonContainer, CurrentMonth, EditModal } from './EmployeePageStyledComponents';
...
const EmployeePage = ({ employeeData }) => {
    ...
    const handleShiftSelect = (record) => {
    ...
    }, [isAdmin, employeeData, selectedMonth, selectedYear]);
        ...
        <PageContainer>
            ...
            <BottomContainer>
                ...
                <InnerBottomContainer>
                    ...
                    <ButtonContainer>
                        <Button onClick={handleNextMonth}><ArrowRightCircleFill size={30} style={{ color: '#8B8E90', cursor: 'pointer' }} /></Button>
                        <CurrentMonth>{" " + displayMonth + " " + selectedYear + " "}</CurrentMonth>
                        <Button onClick={handlePrevMonth}><ArrowLeftCircleFill size={30} style={{ color: '#8B8E90', cursor: 'pointer' }} /></Button>
                    </ButtonContainer>
                    <EmployeeList>
                ...
                <>
                    ...
                    <Modal ref={modalRef}>
                        {showRegister ?
                            ...
                            :
                            <ShiftCard shifts={shifts} handleShiftSelect={handleShiftSelect} />
                        }
                    </Modal>
                </>
            }
